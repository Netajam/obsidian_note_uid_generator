import { MarkdownView, TFile, TFolder, Notice, normalizePath, WorkspaceLeaf, FileExplorerView } from 'obsidian';
...
export async function handleGenerateUpdateUid(plugin: UIDGenerator, overwrite: true): Promise<void> {
